...
+ (NSString *)platformString
{
    ...
    NSLog(@"Device Platform:%@", modelIdentifier);
...
+ (NSString *)resolution
{
    ...
    CGFloat width = bounds.size.width * [UIScreen mainScreen].scale;
    CGFloat height = bounds.size.height * [UIScreen mainScreen].scale;
